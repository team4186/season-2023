...
import frc.commands.targeting.TurnToRamp
...
//            ),
        ...
        //Align to target
        Trigger { joystick0.getRawButton(11) || joystick0.getRawButton(12) }
            .whileTrue(
                turnToTarget
            ),
                ...
                MoveCarriage(
                    ...
                    .andThen(
                        ...
                        LeaveLine(
                            ...
                            leftEncoder = { leftEncoder.position },
                            gyro = gyro
                        ).until { gyro.pitch > 8.0 || gyro.pitch < -8.0 }
                            .withTimeout(2.0)
                    ).andThen(
                        GyroBalance(
                            forward = PIDController(
...
//            addOption(
//                "Eject, Move Past Charge & Balance",
//                MoveCarriage(
//                    elevatorSubsystem,
//                    CARRIAGE_END
//                ).until { elevatorSubsystem.carriageLimitTop.get() }
//                    .andThen(
//                        Eject(intakeSubsystem)
//                            .withTimeout(0.25)
//                    )
//                    .andThen(
//                        MoveCarriage(
